...
')
     ...
     */ 
        ...
        public static function getRoutes()
        {
                        /** @var \BeyondCode\LaravelWebSockets\Server\Router $instance */
                        return $instance->getRoutes();
        }
                    /**
         * Get the list of routes that still need to be registered.
         *
         * @return \BeyondCode\LaravelWebSockets\Server\array[Collection] 
         * @static 
         */ 
        public static function getCustomRoutes()
        {
                        /** @var \BeyondCode\LaravelWebSockets\Server\Router $instance */
                        return $instance->getCustomRoutes();
        }
                    /**
        ...
        {
                        /** @var \BeyondCode\LaravelWebSockets\Server\Router $instance */
                        $instance->addRoute($method, $uri, $action);
        }
                    /**
         ...
         * @static 
         */ 
        public static function addCustomRoute($method, $uri, $action)
        {
                        /** @var \BeyondCode\LaravelWebSockets\Server\Router $instance */
                        $instance->addCustomRoute($method, $uri, $action);
        }
                    /**
